...
INSERT INTO `harvest` (`harvest_id`, `harvest_num`, `room_num`, `plant_date`, `harvest_date`, `actual_harvest_date`) VALUES
(1, 43, 4, '2021-08-08', '2021-12-15', '2022-02-26'),
(2, 45, 8, '2021-08-08', '2021-12-15', '0000-00-00'),
(3, 47, 9, '2021-08-08', '2021-12-15', '0000-00-00'),
(4, 46, 10, '2021-08-08', '2021-12-15', '0000-00-00'),
(5, 48, 1, '2021-08-08', '2021-12-15', '0000-00-00'),
(6, 44, 7, '2021-08-08', '2021-12-15', '0000-00-00'),
(7, 12, 1, '2022-02-02', '2022-03-08', '0000-00-00'),
(8, 69, 34, '2022-02-01', '2022-02-28', '0000-00-00'),
(9, 34, 21, '2022-02-01', '2022-02-08', '0000-00-00'),
(10, 7, 3, '2022-02-09', '2022-03-12', '0000-00-00'),
(11, 2, 3, '2022-02-01', '2022-04-02', '0000-00-00'),
(12, 46, 8, '2021-12-08', '2022-02-21', '0000-00-00');
...
INSERT INTO `strain` (`id`, `name`, `short_name`, `license`) VALUES
(1, 'LA Kush Cake', 'LAKC', 'AU-C-000141'),
(2, 'Motor Cake', 'MC', 'AU-C-00034'),
(3, 'Grim Bastard OG', 'GBOG', 'GR-C-0078'),
(4, 'Diamond Dust', 'DD', 'AU-U-EX-00334');
...
INSERT INTO `weight` (`weight_id`, `de_stem_id`, `strain_id`, `weight`, `measurement_type_id`, `date`) VALUES
(1, 1, 1, 4000, 1, '2022-02-14');
...
--
ALTER TABLE `harvest`
  MODIFY `harvest_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
