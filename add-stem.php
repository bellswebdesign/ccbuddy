...
if (isset($_POST["submit"])) {
    $formData = $_POST["stem"];
    $addStrain = new AddStemWeight();
    $addStrain->processAddStem();
}
...
<div class="container-fluid">
  <div class="row">
    ...
    <form class="<?= pageSlug($pageTitle); ?>" action="" method="post">
        ...
        <input type="hidden" name='stem[id]'>
        <input type="hidden" name='stem[de_stem_id]' value="<?= $id ?>">
        <input type="hidden" name='stem[action]' value="addStem">
            ...
            <div class="container col-md-10 offset-md-2">
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <div class="input-group">
                            <input type="number" class="form-control textupcase" placeholder="Weight" name='stem[weight]'>
                        </div>
                    </div>
                </div>
