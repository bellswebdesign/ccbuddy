...
if (isset($_POST["submit"])) {
    $formData = $_POST["department"];
    $addDepartment = new AddDepartment();
    $addDepartment->processAddDepartment();
}
...
<div class="container-fluid">
  <div class="row">
    ...
    <form class="<?= pageSlug($pageTitle); ?>" action="" method="post">
        ...
        <input type="hidden" name='department[action]' value="addDepartment">
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Department Name" name='department[name]'>
                        </div>
                    </div>
                </div>
